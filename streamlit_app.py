...
Track hiring trends over time, visualize employee distribution across provinces, and delve into generational and gender insights within departments—all in one comprehensive view.""")
#--- ROW 2 ---#
